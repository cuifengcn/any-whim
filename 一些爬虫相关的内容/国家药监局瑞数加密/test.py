...
def a0():
    ...
    return ca
def a5():
    c3 = spliter_1(main_spliter(s)).split('`')
...
def al(ca):
    ...
    c3 = [None] * sb
    lk = 0
    st = 'S]"y1Q4\'*/orc!%EBaTliq~ 0?Xf6<:HtU|$YGP2#Cw735dOeJZ=W.}x_;(k\\j^n`Kb&{p-+v8D9hI,V)s[ugRLNMFAz>@m'
    while lk < sb:
        # 目前问题的关键出现的st的处理上面，#
...
# v = deal_box('wP3dxhyJgpbC6tVm_ewcCO')
# print(v)
mq()
