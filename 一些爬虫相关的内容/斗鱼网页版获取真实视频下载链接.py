...
def get_m3u8_url(url):
    ...
    def mk_url_headers_body(pbody):
        ...
        headers = {
            ...
            "cookie": (
                ...
                "acf_auth=; "
                "acf_auth_wl=; "
                "acf_did=a9e8e1b84915288bad2dc11700081501; "
                "acf_groupid=; "
                "acf_nickname=; "
                "acf_notification=; "
                "acf_own_room=; "
                ...
                "acf_uid=; "
                "acf_username=; "
                "dy_did=a9e8e1b84915288bad2dc11700081501; "
                "Hm_lpvt_e99aee90ec1b2106afe7ec3b199020a7=1572862327"
            ),
            "origin": "https://v.douyu.com",
            "pragma": "no-cache",
            "referer": "https://v.douyu.com/show/{}".format(pbody.get('vid')),
            "sec-fetch-mode": "cors",
    ...
    pbody = get_m3u8_pbody(html.unescape(script.decode()))
