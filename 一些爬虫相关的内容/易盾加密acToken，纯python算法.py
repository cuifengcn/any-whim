...
# "351,-46,3679"
# 每个轨迹都会加密成一个字符串形成列表，加密函数为 y（例如 y("351,-46,3679") ），并且需要 token 参数，加密后的每个点信息都存在一个列表里
...
# 点击次数和轨迹信息列表长度，取真实长度，（不取规约成最大50的长度，如果长度是200就写200），用逗号分隔
token = '072b86090d6f4a8c9c9cfaf5284624de'
t = "1,200"
e = y(token, t)
v = p(e)
