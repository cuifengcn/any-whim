...
# 指纹相关的处理，目前至少能绕过药监局的瑞数 20200330，瑞数的浏览器检测似乎有点弱。
...
webdriver.get('http://app1.sfda.gov.cn/datasearchcnda/face3/base.jsp?tableId=25&tableName=TABLE25&title=%B9%FA%B2%FA%D2%A9%C6%B7&bcId=152904713761213296322795806604')